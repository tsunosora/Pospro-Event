        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative bg-background border border-border rounded-2xl shadow-2xl w-full max-w-2xl max-h-[92vh] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
                            ...
                            {editItems.map((item, idx) => (
                                <div
                                    ...
                                    className={`p-3 rounded-xl border transition-all ${item.remove
                                        ? 'opacity-40 bg-destructive/5 border-destructive/30 line-through'
                                        : item.isNew
                                    ...
                                    <div className="flex items-start justify-between gap-2 mb-2.5">
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-medium text-foreground truncate">
                                                {item.isNew && <span className="text-[10px] font-bold text-success uppercase mr-1.5 bg-success/10 px-1.5 py-0.5 rounded">Baru</span>}
                                        ...
                                        <button
                                            ...
                                            className={`p-1.5 rounded-lg transition-colors shrink-0 ${item.remove ? 'text-muted-foreground hover:bg-muted' : 'text-destructive hover:bg-destructive/10'}`}
                                        >
                                    ...
                                    {!item.remove && (
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-2 pt-1 border-t border-border/50">
                                                ...
                                                <span className="text-xs font-semibold text-foreground shrink-0 min-w-[80px] text-right nums">
                        ...
                        {summaryOpen && (
                            <div className="p-4 space-y-4">
                                ...
                                <div className="flex justify-between items-center text-sm">
                                    ...
                                    <span className="font-medium nums">{fmt(subtotal)}</span>
                                </div>
                                ...
                                <div className="flex justify-between items-center pt-1 border-t border-border text-sm font-semibold">
                                    ...
                                    <span className="text-primary nums">{fmt(grandTotal)}</span>
                                </div>
                    ...
                    {error && (
                        <div className="p-3 bg-destructive/12 border border-destructive/20 rounded-lg text-xs text-destructive">
                    ...
                    {isManager && (
                        deleteConfirm === 'idle' ? (
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-2 text-destructive hover:bg-destructive/10 rounded-lg text-xs font-medium transition-colors border border-destructive/30 hover:border-destructive/60"
                            >
