...
import {
    Bell, Clock, MessageSquare, GitCommit,
    ...
    return (
        <div className="max-w-3xl space-y-6">
            ...
            >
                ...
                {form.notifyLowStock && (
                    <div className="pl-4 border-l-2 border-warning/30 ml-2">
                ...
                {form.notifyShiftReminder && (
                    <div className="pl-4 border-l-2 border-info/30 ml-2 space-y-3">
                        ...
                        <div>
                            <label className="text-xs font-medium text-muted-foreground flex items-center gap-1 mb-1">
                                <Clock className="w-3 h-3" /> Shift 1 — Jam Pengingat
                            </label>
                            <input
                                type="time"
                        ...
                        <div>
                            <label className="text-xs font-medium text-muted-foreground flex items-center gap-1 mb-1">
                                <Clock className="w-3 h-3" /> Shift 2 — Jam Pengingat
                            </label>
                            <input
                                type="time"
            ...
            >
                <div className="bg-info/10 border border-info/20 rounded-lg p-3 text-sm text-info flex gap-2">
                ...
                {form.discordWebhookUrl && (
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="flex items-center gap-2 bg-info text-white px-3 py-1.5 rounded-lg text-sm font-medium cursor-pointer hover:opacity-90 transition-opacity"
                        >
                            <Send className="w-3.5 h-3.5" />
                            Kirim Test
                        </button>
                        {testDiscordResult && (
                            <p className={`text-xs font-medium ${testDiscordResult.startsWith('✅') ? 'text-success' : 'text-destructive'}`}>
                                {testDiscordResult}
                            </p>
                        )}
                    </div>
            ...
            >
                <div className="bg-primary/10 border border-primary/20 rounded-lg p-3 text-sm text-primary flex gap-2">
                    <Info className="w-4 h-4 shrink-0 mt-0.5" />
                    <div>
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1.5 border border-border rounded-lg px-3 py-2 text-sm cursor-pointer hover:bg-muted transition-colors"
                        >
                ...
                <div className="bg-muted border border-border rounded-xl p-4 space-y-2">
                    ...
                    <ol className="text-xs text-muted-foreground space-y-1.5 list-decimal ml-4">
                        ...
                        <li>Ubah <strong>Content type</strong> ke <code className="bg-background px-1 rounded">application/json</code></li>
