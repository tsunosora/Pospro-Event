...
export function middleware(request: NextRequest) {
    ...
    const isPublicPage = pathname.startsWith('/opname/') || pathname.startsWith('/produksi') || pathname.startsWith('/cetak') || pathname.startsWith('/p/') || pathname.startsWith('/so-designer') || pathname.startsWith('/gudang/ambil') || pathname.startsWith('/gudang/stok') || pathname.startsWith('/share/') || pathname.startsWith('/pic/') || pathname.startsWith('/jadwal') || pathname.startsWith('/vote');
