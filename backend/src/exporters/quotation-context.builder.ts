...
export const I18N: Record<'id' | 'en', Record<string, string>> = {
    id: {
        ...
        tanggal: 'Tanggal',
        // Totals & sections tambahan
        spesifikasi: 'Spesifikasi',
        specificationLabel: 'Spesifikasi:',
        totalHargaPenawaran: 'Total Harga Penawaran',
        hargaPaket: 'Harga Paket',
        jumlahDiterima: 'Jumlah Diterima',
        dipotongKlien: '(dipotong klien)',
        sebesar: 'sebesar',
        // Bank / pembayaran
        pembayaranTransferKe: 'Pembayaran Transfer Ke',
        pembayaranRekeningIntro: 'Pembayaran dapat di transfer melalui rekening berikut:',
        atau: 'atau',
        namaBank: 'Nama Bank',
        atasNama: 'Atas nama',
        ...
        jumlahDitagih: 'JUMLAH YANG DITAGIH',
        jumlahDitagihDp: 'JUMLAH YANG DITAGIH (DP)',
        jumlahDitagihPelunasan: 'JUMLAH YANG DITAGIH (PELUNASAN)',
        nb: 'Nb :',
        // Closing & header
        penawaranClosingDefault: 'Demikian penawaran ini kami sampaikan. Atas perhatian dan kerjasamanya kami ucapkan terima kasih.',
        telp: 'Telp:',
        lampiranBerkas: '1 (satu) berkas',
        // SPK (Surat Perintah Kerja)
        spkTitle: 'Surat Perintah Kerja',
        spkCompanyName: 'Nama Perusahaan',
        spkPic: 'Penanggung Jawab',
        spkPosition: 'Jabatan',
        spkOfficePhone: 'No. Telp kantor',
        spkAddress: 'Alamat',
        spkEvent: 'Event',
        spkPlace: 'Tempat',
        spkEventDate: 'Tanggal Event',
        spkAssign1: 'Dengan ini memberikan pekerjaan kepada',
        spkInstall: 'untuk pemasangan',
        spkOnEvent: 'pada Event',
        spkDate: 'tanggal',
        spkAt: 'di',
        spkAmountOf: 'yaitu sebesar',
        spkExclTax: 'exclude PPN dan PPH',
        spkInclTax: 'sudah termasuk PPN',
        spkWithSpecs: 'dengan spesifikasi sebagai berikut:',
        spkDpLabel: 'DP',
        spkSchedOfContract: 'dari nominal kontrak sebesar',
        spkDpOfContract: 'dari nominal kontrak atau sebesar',
        spkPaidOnSign: 'dibayarkan pada saat surat perintah kerja ini ditandatangani',
        spkFinalSettle: 'sebagai pelunasan akhir',
        spkInInstallments: 'dibayarkan secara bertahap',
        spkPelunasanOf: 'Pelunasan sebesar',
        spkPaidOnBooth: 'dibayarkan pada saat booth berdiri',
        spkOrNoLater: 'atau selambat-lambatnya pada tanggal',
        spkCancel1: 'Surat Perintah Kerja tidak bisa dibatalkan. Apabila terjadi pembatalan, maka pembatalan akan dikenakan biaya 50% dari total harga. Dan dibayarkan maksimal 1 (satu) minggu dari pembatalan surat perintah kerja. Pembayaran DP yang sudah kami terima tidak dapat dikembalikan.',
        spkCancel2: 'Pembatalan Surat Perintah Kerja disampaikan secara tertulis.',
        spkBankIntro: 'Pembayaran dapat ditransfer ke rekening :',
        spkClosing: 'Demikian Surat Perintah Kerja dibuat dan ditandatangani atas kesepakatan bersama :',
    ...
    en: {
        ...
        totalHargaPenawaran: 'Total Quotation Price',
        hargaPaket: 'Package Price',
        jumlahDiterima: 'Amount Received',
        dipotongKlien: '(withheld by client)',
        sebesar: 'amounting to',
        // Bank / payment
        pembayaranTransferKe: 'Payment Transfer To',
        pembayaranRekeningIntro: 'Payment can be made via bank transfer to the following account:',
        atau: 'or',
        namaBank: 'Bank Name',
        ...
        accHolderShort: 'a/n',
        // Invoice billed amount
        jumlahDitagih: 'AMOUNT BILLED',
        jumlahDitagihDp: 'AMOUNT BILLED (DOWN PAYMENT)',
        jumlahDitagihPelunasan: 'AMOUNT BILLED (FINAL PAYMENT)',
        nb: 'Note :',
        // Closing & header
        penawaranClosingDefault: 'This concludes our quotation. We sincerely appreciate your kind attention and cooperation.',
        telp: 'Phone:',
        lampiranBerkas: '1 (one) document',
        // SPK (Work Order)
        spkTitle: 'Work Order',
        spkCompanyName: 'Company Name',
        spkPic: 'Person in Charge',
        spkPosition: 'Position',
        spkOfficePhone: 'Office Phone',
        spkAddress: 'Address',
        spkEvent: 'Event',
        spkPlace: 'Venue',
        spkEventDate: 'Event Date',
        spkAssign1: 'Hereby assigns the following work to',
        spkInstall: 'for the installation of',
        spkOnEvent: 'for the Event',
        spkDate: 'on',
        spkAt: 'at',
        spkAmountOf: 'amounting to',
        spkExclTax: 'excluding VAT and WHT',
        spkInclTax: 'including VAT',
        spkWithSpecs: 'with the following specifications:',
        spkDpLabel: 'Down Payment',
        spkSchedOfContract: 'of the contract value, amounting to',
        spkDpOfContract: 'of the contract value, amounting to',
        spkPaidOnSign: 'payable upon signing of this work order',
        spkFinalSettle: 'as the final settlement',
        spkInInstallments: 'paid in installments',
        spkPelunasanOf: 'Final payment of',
        spkPaidOnBooth: 'payable upon completion of the booth setup',
        spkOrNoLater: 'or no later than',
        spkCancel1: 'This Work Order cannot be cancelled. In the event of cancellation, a charge of 50% of the total price shall apply, payable within a maximum of 1 (one) week from the cancellation of the work order. Any down payment already received is non-refundable.',
        spkCancel2: 'Cancellation of the Work Order must be submitted in writing.',
        spkBankIntro: 'Payment can be transferred to the following account:',
        spkClosing: 'This Work Order has been made and signed by mutual agreement:',
        materai: 'Stamp Duty 10000',
    },
};
